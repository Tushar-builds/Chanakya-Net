...
Unable to detect network-level collusion

As a result, coordinated fraud (shell companies, shared directors, shared bank accounts) often goes undetected.
 ### Our Solution

Chanakya-Net transforms auditing into a proactive, data-driven process by:

Modeling entities (companies, people, accounts) as a graph

Learning hidden relationships using Graph Neural Networks

Detecting abnormal financial behavior using unsupervised anomaly detection
...
Synthetic but realistic data for demonstration
